...
import { of } from 'rxjs';
import { CitiesComponent } from './cities.component'; import { City } from './city';
...
describe('CitiesComponent', () => {
    ...
    beforeEach(async () => {
        ...
        //create a mock cityService with a mock 'getData' method
    ...
    it("should contain a table with a list of one or more cities", () => {
        let table = fixture.nativeElement.querySeelctor("table.mat-mdc-table");
